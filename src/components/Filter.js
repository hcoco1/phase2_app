...
function Filter({ filteredProperties, priceCategory, typeCategory, operationCategory, onPriceCategoryChange, onOperationCategoryChange, onTypeCategoryChange }) {
        ...
        <>
            ...
            <div className="Filter">
                <form className="form-inline">
                    ...
                    <label className="mr-sm-2" for="inlineFormCustomSelect">Price</label>
                    <select
                    ...
                    <label className="mr-sm-2" for="inlineFormCustomSelect2">   Property Type   </label>
                    <select
                        className="custom-select mb-2 mr-sm-2 mb-sm-0"
                    ...
                    <label className="mr-sm-2" for="inlineFormCustomSelect3">Sale or Rent?</label>
                    <select
                        className="custom-select mb-2 mr-sm-2 mb-sm-0"
